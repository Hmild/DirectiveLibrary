...
/**
  ...
  */
CMD_Network_State_t CMD_Network_Directive_Add(CMD_Network_Handle_t handle, uint32_t directive_logo, void(*send_func)(void), char *(*check_func)(char *frame));
...
/**
  ...
  */
CMD_Network_State_t CMD_Network_Directive_Delete(CMD_Network_Handle_t handle, uint32_t directive_logo);
